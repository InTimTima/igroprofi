...
const AUTH_I18N = {
  ru: {
    ...
    donateText: 'Если хотите помочь автору — будем очень рады любой поддержке. Спасибо, что вы с нами!',
    donateAmountLabel: 'Сумма доната (₽)',
    donateAmountPlaceholder: 'Например, 500',
    donatePay: 'Поддержать',
    donateNote: 'Оплата через ЮKassa. Минимальная сумма — 1 ₽.',
  ...
  en: {
    ...
    donateBtn: '❤ Support the author',
    donateTitle: 'Support the author',
    donateText: 'If you want to help the author — we will be very grateful for any support. Thank you for being with us!',
    donateAmountLabel: 'Donation amount (₽)',
    donateAmountPlaceholder: 'e.g. 500',
    donatePay: 'Donate',
    donateNote: 'Paid via YooKassa. Minimum amount — 1 ₽.',
